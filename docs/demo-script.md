...
2. **Never claim literal 0ms or universal sub-millisecond end-to-end latency**: Use *"fast deterministic path"*, *"observed gateway timing"*, or *"low-latency"*.
